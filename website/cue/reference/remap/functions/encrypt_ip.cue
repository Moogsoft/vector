	...
	examples: [
		{
			...
			source: #"""
				encrypted_ip = encrypt_ip!("192.168.1.1", b"sixteen byte key", "aes128")
				encrypted_ip
				"""#
		...
		},
		{
			...
			source: #"""
				encrypted_ip = encrypt_ip!("2001:db8::1", b"sixteen byte key", "aes128")
				encrypted_ip
				"""#
		...
		},
		{
			...
			source: #"""
				encrypted_ip = encrypt_ip!("192.168.1.1", b"thirty-two bytes key for pfx use", "pfx")
				encrypted_ip
				"""#
		...
		},
		{
			...
			source: #"""
				encrypted_ip = encrypt_ip!("2001:db8::1", b"thirty-two bytes key for ipv6pfx", "pfx")
				encrypted_ip
				"""#
