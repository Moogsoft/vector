...
pub enum Sources {
    ...
    /// Moogsoft Redis Metrics
    #[cfg(feature = "sources-moogsoft_redis_metrics")]
    MoogsoftRedisMetrics(#[configurable(derived)] moogsoft_redis_metrics::RedisMetricsConfig),

    /// Moogsoft Docker Metrics
    #[cfg(feature = "sources-docker_metrics")]
    MoogsoftDockerMetrics(#[configurable(derived)] moogsoft_docker_metrics::DockerMetricsConfig),
...
impl NamedComponent for Sources {
    ...
    fn get_component_name(&self) -> &'static str {
        match self {
            ...
            #[cfg(feature = "sources-moogsoft_redis_metrics")]
            Self::MoogsoftRedisMetrics(config) => config.get_component_name(),
            #[cfg(feature = "sources-docker_metrics")]
            Self::MoogsoftDockerMetrics(config) => config.get_component_name(),
            #[cfg(all(feature = "sources-nats"))]
