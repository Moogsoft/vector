...
pub enum Transforms {
    ...
    /// AppDynamics event converter
    #[cfg(feature = "transforms-appdynamics")]
    Appdynamics(#[configurable(derived)] appdynamics::AppDynamicsConfig),
    ...
    /// Moogsoft internal logs
    #[cfg(feature = "transforms-moogsoft")]
    MoogsoftInternalLogs(
        #[configurable(derived)]
        moogsoft::moogsoft_internal_logs::MoogsoftInternalLogsTransformConfig,
    ),

    /// Moogsoft uptime converter, etc
    #[cfg(feature = "transforms-moogsoft")]
    MoogsoftController(
        #[configurable(derived)] moogsoft::moogsoft_controller::MoogsoftControllerTransformConfig,
    ),

    /// Moogsoft add tags
    #[cfg(feature = "transforms-moogsoft")]
    Moogsoft(#[configurable(derived)] moogsoft::moogsoft_tags::MoogsoftConfig),
...
impl NamedComponent for Transforms {
    ...
    fn get_component_name(&self) -> &'static str {
        match self {
            ...
            #[cfg(feature = "transforms-appdynamics")]
            Transforms::Appdynamics(config) => config.get_component_name(),
            #[cfg(feature = "transforms-aws_ec2_metadata")]
            ...
            #[cfg(feature = "transforms-moogsoft")]
            Transforms::MoogsoftInternalLogs(config) => config.get_component_name(),
            #[cfg(feature = "transforms-moogsoft")]
            Transforms::MoogsoftController(config) => config.get_component_name(),
            #[cfg(feature = "transforms-moogsoft")]
            Transforms::Moogsoft(config) => config.get_component_name(),
            #[cfg(feature = "transforms-pipelines")]
